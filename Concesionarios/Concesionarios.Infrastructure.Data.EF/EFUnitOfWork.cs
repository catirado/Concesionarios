...
namespace Concesionarios.Infrastructure.Data.EF
{
    ...
    public class EFUnitOfWork : IUnitOfWork
    {
        ...
        private EFUnitOfWork _parentScope;
        private DbContextCollection _dbContexts;
        
        public EFUnitOfWork(IDbContextFactory dbContextFactory = null) :
        ...
        public EFUnitOfWork(bool readOnly, IDbContextFactory dbContextFactory = null)
        ...
        public EFUnitOfWork(DbContextScopeOption joiningOption, bool readOnly, IsolationLevel? isolationLevel, IDbContextFactory dbContextFactory = null)
        {
...
" + Environment.StackTrace;
        ...
        private static readonly ConditionalWeakTable<InstanceIdentifier, EFUnitOfWork> DbContextScopeInstances = new ConditionalWeakTable<InstanceIdentifier, EFUnitOfWork>();
        ...
        /// </summary>
        internal static void SetAmbientScope(EFUnitOfWork newAmbientScope)
        {
        ...
        /// </summary>
        internal static EFUnitOfWork GetAmbientScope()
        {
