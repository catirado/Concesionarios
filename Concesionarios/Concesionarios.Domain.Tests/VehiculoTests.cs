...
namespace Concesionarios.Domain.Tests
{
    ...
    public class VehiculoTests
    {
        ...
        public void CreateValidVehiculo()
        {
            ...
            var vehiculo = new Vehiculo(id, marca, modelo, potencia);
            Assert.AreEqual(vehiculo.Id, id);
        ...
        {
            var vehiculo = new Vehiculo(1, String.Empty, "Astra", 220);
        }
        ...
        {
            var vehiculo = new Vehiculo(1, null, "Astra", 220);
        }
        ...
        {
            var vehiculo = new Vehiculo(1, "Opel", String.Empty, 220);
        }
        ...
        {
            var vehiculo = new Vehiculo(1, "Opel", null, 220);
        }
        ...
        public void ChangeMarcaModifyMarca()
        {
            ...
            var vehiculo = new Vehiculo(1, "Opel", "Astra", 220);
